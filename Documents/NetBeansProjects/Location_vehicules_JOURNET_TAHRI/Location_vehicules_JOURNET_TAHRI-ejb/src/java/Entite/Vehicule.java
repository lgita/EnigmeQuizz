...
public class Vehicule implements Serializable {
    ...
    public List<Location> getLeslocations() {
        return Leslocations;
    }

    public void setLeslocations(List<Location> Leslocations) {
    ...
    //Etant donné que la caution est lié à la somme de la franchise contractée qui dépend de la catégorie du véhicule loué, la caution sera ajouté à la création du véhicule
    private int caution;
     ...
     *
     * @param caution new value of caution
     */
