...
public class Location implements Serializable {
    ...
    public void setDate_fin_reel(Date Date_fin_reel) {
        this.Date_fin_reel = Date_fin_reel;
           ...
           @Temporal(javax.persistence.TemporalType.DATE)
    private Date Date_fin_prevue30jours;

    /**
     * Get the value of Date_fin_prevu_30jours
     *
     * @return the value of Date_fin_prevu_30jours
     */
    public Date getDate_fin_prevu30jours() {
        return Date_fin_prevue30jours;
    }

    /**
     * Set the value of Date_fin_prevu_30jours
     *
     * @param Date_fin_prevue30jours new value of Date_fin_prevu_30jours
     */
    public void setDate_fin_prevue30jours(Date Date_fin_prevue30jours) {
        this.Date_fin_prevue30jours = Date_fin_prevue30jours;
    }

           @Temporal(javax.persistence.TemporalType.DATE)
    private Date Date_fin_prevue2jours;

    /**
     * Get the value of Date_fin_prevue2jours
     *
     * @return the value of Date_fin_prevue2jours
     */
    public Date getDate_fin_prevue2jours() {
        return Date_fin_prevue2jours;
    }

    /**
     * Set the value of Date_fin_prevue2jours
     *
     * @param Date_fin_prevue2jours new value of Date_fin_prevue2jours
     */
    public void setDate_fin_prevue2jours(Date Date_fin_prevue2jours) {
        this.Date_fin_prevue2jours = Date_fin_prevue2jours;
    }
    ...
    private double Montant_payer_caution;

    /**
     * Get the value of Montant_payer_caution
     *
     * @return the value of Montant_payer_caution
     */
    public double getMontant_payer_caution() {
        return Montant_payer_caution;
    }

    /**
     * Set the value of Montant_payer_caution
     *
     * @param Montant_payer_caution new value of Montant_payer_caution
     */
    public void setMontant_payer_caution(double Montant_payer_caution) {
        this.Montant_payer_caution = Montant_payer_caution;
    }
